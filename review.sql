...
`version`
int(10) unsigned NOT NULL DEFAULT '0' COMMENT '乐观锁标记',
...
`op_user` varchar(64) NOT NULL DEFAULT '' COMMENT '运营者标识',`goods_snapshoot` varchar(2048) NOT NULL DEFAULT '' COMMENT '商品快照信息',
...
`id` bigint(32) unsigned NOT NULL AUTO_INCREMENT COMMENT '主键',
`create_by` varchar(48) NOT NULL DEFAULT '' COMMENT '创建⽅标识',
`update_by` varchar(48) NOT NULL DEFAULT '' COMMENT '更新⽅标识',`create_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
`update_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE
CURRENT_TIMESTAMP COMMENT '更新时间',
`delete_at` timestamp NULL DEFAULT NULL COMMENT '逻辑删除标记',
`version` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '乐观锁标记',
